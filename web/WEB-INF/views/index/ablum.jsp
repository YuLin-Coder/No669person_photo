    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user" style="width:1200px;">
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">我的相册</li>
          <button type="button" onclick="add()" class="layui-btn-normal layui-btn" >新建相册</button>
      </ul>
      ...
      <table class="layui-table">
              ...
              <tbody>
			    ...
			    <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-sm layui-btn-normal" type="button" onclick="updateAblum(${data.id})"><i
        ...
        form.render();//这句一定要加，占坑
            ...
            window.updateAblum = function(e){
                layer.open({
                    ...
                    title: '修改相册',
                    //刚才定义的弹窗页面
                    content: 'toUpdateAblum?id='+e, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                });
            }
            ...
            window.add =function () {
                layer.open({
                    ...
                    title: '新建相册',
                    //刚才定义的弹窗页面
                    content: 'toAddAblum', //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                });
            }
