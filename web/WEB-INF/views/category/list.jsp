...
<div class="layui-col-md12">
    <div class="layui-card">
        <div class="layui-card-header">相册类别列表</div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" placeholder="根据类别名称" name="key" id="key" value="${key}"
                                   class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-inline">
                ...
                <c:forEach items="${pageInfo.list}" var="data">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="toUpdateCategory?id=${data.id}"
            ...
            <div class="footpage">
                <ul style="display:flex; flex-direction:row;">
                    <li><a class="layui-btn layui-btn-primary layui-btn-sm"
                           href="CategoryList?currentPage=1">首页</a></li>
                    <li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <a class="layui-btn layui-btn-normal layui-btn-sm"
                               href="CategoryList?currentPage=${pageInfo.pageNum-1}">
                                <span>上一页</span></a>
                        </c:if>
                    </li>
                    ...
                    <li>
                        <a class="layui-btn layui-btn-primary layui-btn-sm"
                           href="CategoryList?currentPage=${pageInfo.pages}">末页</a></li>
