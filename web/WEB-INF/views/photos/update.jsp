...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card-header">修改照片</div>
                    ...
                    <form id="saveForm" method="post" class="layui-form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="title" value="${data.title}" id="title" lay-verify="required" lay-verType="tips"
                                       class="layui-input">
                            </div>
                        </div>
                            ...
                            <div class="layui-input-inline">
                                <select   id="tid" name="tid" >
                                    <c:forEach items="${tips}" var="tip"  >
                                        <option value="${tip.id}" <c:if test="${tip.id == data.tid}">selected</c:if>>${tip.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <select   id="aid" name="aid" >
                                    <c:forEach items="${ablums}" var="ab"  >
                                        <option value="${ab.id}" <c:if test="${ab.id == data.aid}">selected</c:if>>${ab.title}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <textarea  name="note" id="note" lay-verify="required" lay-verType="tips"
