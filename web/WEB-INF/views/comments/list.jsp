...
<div class="layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form action="CommentsList" method="post">

                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" placeholder="根据评论内容" name="key" id="key" value="${key}"
                                   class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-inline">
            ...
            <div class="footpage">
                <ul style="display:flex; flex-direction:row;">
                    <li><a class="layui-btn layui-btn-primary layui-btn-sm"
                           href="CommentsList?currentPage=1">首页</a></li>
                    <li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <a class="layui-btn layui-btn-normal layui-btn-sm"
                               href="CommentsList?currentPage=${pageInfo.pageNum-1}">
                                <span>上一页</span></a>
                        </c:if>
                    </li>

                    <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                        <li ><a class="layui-btn layui-btn-primary layui-btn-sm" href="CommentsList?currentPage=${i }">${i }</a></li>
                    </c:forEach>
                    <li>
                    ...
                    <li>
                        <a class="layui-btn layui-btn-primary layui-btn-sm"
                           href="CommentsList?currentPage=${pageInfo.pages}">末页</a></li>
