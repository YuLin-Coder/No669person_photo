...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card-header">申请朋友</div>

            <div class="layui-card">
                <div class="layui-card-body">
                    <form id="saveForm" class="layui-form">
                        <input type="hidden" name="uid" id="uid" value="${uid}" lay-verify="required" lay-verType="tips"
                               class="layui-input">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <textarea  name="content" id="content" lay-verify="required" lay-verType="tips"
